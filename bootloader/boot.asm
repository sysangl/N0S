...
; Load remaining bootloader sectors (sectors 2-3)
mov bx, 0x0002          ; Start at sector 2
mov cx, 0x0002          ; Load 2 more sectors (total 3 bootloader sectors)
mov dx, 0x7E00          ; Load at 0x7E00 (right after first sector)
call load_bios

; Load kernel (sectors 4-14)
mov bx, 0x0004          ; Start at sector 4
mov cx, 0x0003          ; Load 11 sectors (your kernel)
mov dx, 0x8200          ; Load at 0x8200
...
; This won't be reached with jmp, but keep for debugging
kernel_return_msg: db `Kernel returned (shouldn't happen)`, 0
kernel_launch_msg: db `Launching kernel at 0x8200...`, 0
